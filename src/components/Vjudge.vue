            ...
            <div id="vjudge">
                <div class="card mb-3" style="max-width: 720px;">
                    <div class="row no-gutters">
                        ...
                        <a :href="profileLink"><img src="https://s3.brilliant.com.bd/simon_portfolio/img/logo/vjudge.jpeg" class="card-img" alt="Vjudge"></a>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
...
export default {
    ...
    data() {
        return {
            solved: 0,
            submissions: 0,
            profileLink: "https://vjudge.net/user/"+this.handle
        }
    },
    methods: {
    }
    ...
    async created() {
        ...
        const info_url = 'https://simonislam.com/api/user/vjudge/'+this.handle;
